...
function Hero() {
  ...
  return (
    <header className='bg-Snow h-5/6 flex justify-center items-center font-montserrat w-full py-80'>
        <article className='w-full'>
          ...
          <h2 className='text-center mx-auto w-4/12 text-xl leading-8 mb-3'>
